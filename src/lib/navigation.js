export const navigation = [
  {
    ...
    href: '#',
    links: [{ title: 'Daily dose of atrocity', href: 'https://armchairheavyindustries.com' }],
  },
  {
    title: 'Projects',
    links: [
    ...
    },
    {
      title: 'Trailhead',
      links: [
        { title: 'Trailhead XY Joints', href: 'https://github.com/Armchair-Heavy-Industries/Trailhead-XY-Joints'},
        { title: 'Trailhead Configurator', href: '/configurator/trailhead' }
      ],
    },
      {
    title: 'Contributing',
    links: [
      { title: 'How to contribute', href: '/docs/archetype/how-to-contribute' },
      { title: 'Acknowledgements', href: '/docs/archetype/acknowledgements' },
    ],
  },
];
